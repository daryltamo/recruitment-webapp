    ...
    try {
        ...
        requestModel.createDemandeDevenirAdmin(
            ...
            function (success) {
                if (success) {
                    console.log(
                        'Demande de devenir admin ajoutee avec succes. - (POST /candidat/devenirAdmin)'
                    );
                    ...
                    console.log(
                        "Echec de l'ajout de la demande de devenir admin. - (POST /candidat/devenirAdmin)"
                    );
